export let request = `"seo": {title,description,published,footermin,slug,lang,robots,canonical,schema,"ogimage":ogimage.asset->url,alternates[]{xdefault,"url":altpage->slug,"lang":altpage->lang}},
      content[]{
        ...
        _type == "calculette" => {_type, id, heading, subheading, labelSurface, placeholderSurface, labelGapRangs, placeholderGapRangs, labelGapCeps, placeholderGapCeps, labelTournieres, placeholderTournieres, resultTitle, btnHref, btnContent}
      }`
