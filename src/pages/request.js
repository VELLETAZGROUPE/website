export let request = `"seo": {title,description,slug,robots,canonical,schema,"ogimage":ogimage.asset->url},
      content[]{
        ...
        _type == "hero" => {_type, id, heading, subheading[]{...,_type=="button"=>{color,content,href{isExt,linkExt,'linkInt':linkInt->slug}}},img{alt,duotone,'src':asset->url}},
        ...
        _type == "tableofcontent" => {_type, id, title, items[]{toctext,toctitle,level,img{alt,duotone,'src':asset->url}}},
        _type == "biglist" => {_type, id, size, title, items[]{itemtitle, itemtext, img{'src':asset->url}}},
        ...
        _type == "team" => {_type, id,title,members[]{millesime, devise, parcours, poste,aime,aimepas,cepage,qualite,defaut,anecdote,img{'src':asset->url},name,}},
