export let request = `"seo": {title,description,published,footermin,slug,lang,robots,canonical,schema,"ogimage":ogimage.asset->url,alternates[]{xdefault,"url":altpage->slug,"lang":altpage->lang}},
      content[]{
        ...
        _type == "productlist" => {_type, height, col, id, title[]{..., markDefs[]{..., _type == "internalLink" =>{...,"href":reference->slug}} ,_type == "button" => {color, size, href{isExt, 'linkInt':linkInt->slug, linkExt}}}, hasfilter, products[]{producttitle, filters, 'link':link->slug, level, img{alt, duotone, 'src':asset->url},isExt, 'linkInt':linkInt->slug, linkExt, itemtext[]{...,markDefs[]{..., _type == "internalLink" =>{...,"href":reference->slug}} , _type == "button" => {color, size, href{isExt, 'linkInt':linkInt->slug, linkExt}}}}},
        _type == "map" => {_type, id, reverse, img{alt,duotone,'src':asset->url},title[]{..., _type == "button" => {color, size, href{isExt, 'linkInt':linkInt->slug, linkExt}}}, poi[]{coord,name,content[]{..., _type == "button" => {color, size, href{isExt, 'linkInt':linkInt->slug, linkExt}}},poiimg{alt,duotone,'src':asset->url}}},
        ...
        _type == "team" => {_type, id,title,contact,bio,members[]->{...,img{'src':asset->url}}},
        ...
        _type == 'title' => {_type, id, content[]{...,_type=="button" => {color, size, href{isExt, 'linkInt':linkInt->slug, linkExt}}}, img{alt,duotone,'src':asset->url}},
        ...
        _type == "productlistcustom" => {_type, id, link, height, col, title, prods[]->{'name':name,slug,img{'src':asset->url}}},
        ...
        _type == "calculette" => {_type, id, heading, subheading, labelSurface, placeholderSurface, labelGapRangs, placeholderGapRangs, labelGapCeps, placeholderGapCeps, labelTournieres, placeholderTournieres, resultTitle, btnHref{isExt, 'linkInt':linkInt->slug, linkExt}, btnContent}
      }`
